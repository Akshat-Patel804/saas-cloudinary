...
const VideoCard: React.FC<VideoCardProps> = ({ video, onDownload }) => {
    ...
    const getPreviewVideoUrl = useCallback((publicId: string)=>{
        return getCldVideoUrl({
            ...
            width: 400,
            height: 225,
            rawTransformations: ["e_preview: duration_15:max_sag_9:min_sag_1"]  
        })
    },[])
    ...
    const formatDuration = useCallback((seconds: string | number) => {
        ...
        const validSeconds = Number.isFinite(parsedSeconds) ? parsedSeconds : 0;
          ...
          <div className="card-body p-4">
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <button
                ...
                onClick={() =>
                  onDownload({ url: getFullVideoUrl(video.publicId), title: video.title })
                }
              >
                <Download size={16} />
              </button>
